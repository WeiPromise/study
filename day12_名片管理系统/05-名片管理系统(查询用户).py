...
def modify_user():
    ...
    if check_number(number):
        ...
        for u in user_list:
            if u['name'] == new_name:
                print('用户名已被占用,name = {}'.format(new_name))
                modify_user()
                return
        new_tel = input('请输新的手机号：')
...
def search_user():
    ...
    for user in user_list:
        ...
        print('没有找到该用户信息')
def show_all():
    print('{}\t{}\t{}\t{}'.format('序号','姓名','手机号'.center(15),'QQ'))
    for i,u in enumerate(user_list):
        print("{}\t{}\t{}\t{}".format(i+1,u['name'].center(12),u['tel'].center(10),u['qq'].center(10)))
